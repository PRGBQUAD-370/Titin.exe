...
DWORD WINAPI profect(LPVOID lpParam) {
    ...
    while (1) {
        HDC hdc = GetDC(0);
        BitBlt(hdc, 0, 0, w, h, hdc, -30, 0, SRCERASE);
        BitBlt(hdc, 0, 0, w, h, hdc, w - 30, 0, SRCERASE);
...
DWORD WINAPI shader1(LPVOID lpParam) {
    ...
    for (int i = 0;; i++, i %= 3) {
        ...
        int v = 0; BYTE bt = 0;
        if ((GetTickCount64() - ticks) > 60000) bt = rand() & 0xffffff;
        for (int i = 0; w * h > i; i++) {
...
DWORD WINAPI shader2(LPVOID lpParam) {
    ...
    for (;;) {
        ...
        BitBlt(deskMem, 0, 0, sw, sh, desk, 0, 0, SRCERASE);
...
DWORD WINAPI polybeziers(LPVOID lpParam) {
...
DWORD WINAPI prgbtriple(LPVOID lpParam) {
    HDC desk = GetDC(0); HWND wnd = GetDesktopWindow();
    int sw = GetSystemMetrics(0), sh = GetSystemMetrics(1);
    BITMAPINFO bmi = { 40, sw, sh, 1, 24 };
    PRGBTRIPLE rgbtriple;
...
VOID WINAPI sound2() {
    ...
    char buffer[8000 * 30] = {};
    for (DWORD t = 0; t < sizeof(buffer); ++t)
        buffer[t] = (BYTE)(t * (t >> 12) * 64 + (t >> 1) * (t >> 10) * (t >> 11) * 48 >> ((t >> 16 | t >> 17) & 1));
...
VOID WINAPI sound3() {
    ...
    char buffer[8000 * 47] = {};
    for (DWORD t = 0; t < sizeof(buffer); ++t)
        buffer[t] = (BYTE)(10 * (t >> 7 | 3 * t | t >> (t >> 15)) + (t >> 8 & 5));
...
VOID WINAPI sound4() {
    ...
    for (DWORD t = 0; t < sizeof(buffer); ++t)
        buffer[t] = (BYTE)(2 * (t >> 5 & t) - (t >> 5) + t * (t >> 14 & 14));
...
VOID WINAPI sound5() {
    ...
    char buffer[8000 * 30] = {};
    for (DWORD t = 0; t < sizeof(buffer); ++t)
        buffer[t] = (BYTE)(t * (t >> 5 | t >> 8) | t >> 80 ^ t) + 64;
...
VOID WINAPI sound6() {
    ...
    char buffer[8000 * 30] = {};
    for (DWORD t = 0; t < sizeof(buffer); ++t)
        buffer[t] = (BYTE)(9 * t & t >> 4 | 5 * t & t >> 7 | (3 * t & t >> 10) - 1);
...
VOID WINAPI sound7() {
    ...
    for (DWORD t = 0; t < sizeof(buffer); ++t)
        buffer[t] = (BYTE)(t >> 10 ^ t >> 11) % 5 * ((t >> 14 & 3 ^ t >> 15 & 1) + 1) * t % 99 + ((3 + (t >> 14 & 3) - (t >> 16 & 1)) / 3 * t % 99 & 64);
...
VOID WINAPI sound8() {
    ...
    char buffer[8000 * 30] = {};
    for (DWORD t = 0; t < sizeof(buffer); ++t)
        buffer[t] = (BYTE)(t >> 10 | t * 5) & (t >> 8 | t * 4) & (t >> 4 | t * 6);
...
VOID WINAPI sound9() {
    ...
    char buffer[8000 * 30] = {};
    for (DWORD t = 0; t < sizeof(buffer); ++t)
        buffer[t] = (BYTE)((t << 1 & t * 3 & t >> 5 & t >> 10) - 1);
...
VOID WINAPI sound10() {
    ...
    char buffer[8000 * 30] = {};
    for (DWORD t = 0; t < sizeof(buffer); ++t)
        buffer[t] = (BYTE)(t + (t & t ^ t >> 6) - t * (t >> 9 & (t % 16 ? 2 : 6) & t >> 9));
...
VOID WINAPI sound11() {
    ...
    char buffer[8000 * 30] = {};
    for (DWORD t = 0; t < sizeof(buffer); ++t)
        buffer[t] = (BYTE)(9 * t & t >> 4 | 5 * t & t >> 7 | 3 * t & t >> 10);
...
VOID WINAPI sound12() {
    ...
    char buffer[8000 * 30] = {};
    for (DWORD t = 0; t < sizeof(buffer); ++t)
        buffer[t] = (BYTE)(t >> 6 ^ t & t >> 9 ^ t >> 12 | ((t >> 6 | t << 1) + (t >> 5 | t << 3 | t >> 3) | t >> 2 | t << 1));
...
VOID WINAPI sound13() {
    ...
    char buffer[8000 * 30] = {};
    for (DWORD t = 0; t < sizeof(buffer); ++t)
        buffer[t] = (BYTE)(t >> 6 ^ t & 37 | t + (t ^ t >> 11) - t * ((t % 24 ? 2 : 6) & t >> 11) ^ t << 1 & (t & 598 ? t >> 4 : t >> 10));
